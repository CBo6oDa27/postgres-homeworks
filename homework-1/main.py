...
with psycopg2.connect(database="north",user="postgres",password="123123") as conn:
    with conn.cursor() as cur:
        ...
        with open('north_data/employees_data.csv', 'r') as f:
            ...
            for row in reader:
                ...
                cur.execute("INSERT INTO employees (employee_id, first_name, last_name, title, birth_date, notes) VALUES (%s, %s, %s, %s, %s, %s)", (employee_id, first_name, last_name, title, date_obj, notes))
